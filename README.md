...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-21 08:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dfaf44dc-4e1f-4a2a-a1ee-c7b9beed942e.git
$ cd dfaf44dc-4e1f-4a2a-a1ee-c7b9beed942e
```
